...
[Servidor Backend Express (Node.js)]
          ...
          ▼
[Base de Datos MySQL configurada mediante variables de entorno]
```
...
| :--- | :--- | :--- | :--- | :---: |
| **CP-001** | Registro de Usuario MySQL | Credenciales temporales de prueba | Inserción en tabla `users` con hash PBKDF2 y respuesta 201. | Aprobado |
