        ...
        <div className="flex items-center gap-3">
          {onOpenGuideModal && (
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-cyan-600/30 hover:bg-cyan-600/50 border border-cyan-400/40 text-cyan-200 transition-all font-semibold text-xs sm:text-sm backdrop-blur-sm shadow-md flex items-center gap-1.5"
              title="Consultar Guía de Uso y Manual Técnico"
            >
